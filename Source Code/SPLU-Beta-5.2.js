  ...
  function loadPlays(tmpUser){
    if(SPLUplayData[tmpUser]["total"]==0){
      ...
      for(key in SPLUplayData[tmpUser]){
        ...
        tmpPlayId=key;
        tmpPlayDate=SPLUplayData[tmpUser][key].attributes.date.value;
        tmpPlayGame=SPLUplayData[tmpUser][key].getElementsByTagName("item")[0].attributes.name.value;
