    ...
    var tmpHTML='<div id="hidePlaysButton" style="position: absolute; right: 0px; top: 2px;">'
        ...
        +'<div id="SPLU.PlaysFilters" style="border: 1px solid blue; border-radius: 5px; padding: 3px;">'
          ...
          +'<div>'
            +'<select class="fa" id="SPLU.SelectPlaysFilter" onChange="javascript:{addPlaysFilter(\'GUI\',\'\');}">'
              +'<option class="fa" value="add">&#xf0b0; Add a Filter</option>'
              +'<option class="fa" value="---" disabled>---</option>'
              +'<option class="fa" value="gamename">&#x265a; Game</option>'
              +'<option class="fa" value="playername">&#xf007; Player</option>'
              +'<option class="fa" value="username">&#xf02b; Username</option>'
              +'<option class="fa" value="location">&#xf041; Location</option>'
              +'<option class="fa" value="daterange">&#xf272; Date Range</option>'
              +'<option class="fa" value="winner">&#xf091; Winner</option>'
              +'<option class="fa" value="new">&#xf21d; New Player</option>'
              +'<option class="fa" value="playercount">&#xf0c0; Player Count</option>'
              +'<option class="fa" value="objecttype">&#xf18e; Type</option>'
              +'<option class="fa" value="comments">&#xf27b; Comments</option>'
              +'<option class="fa" value="excludeexpansions">&#xf0eb; No Expansions</option>'
              +'<option class="fa" value="excludenowinstats">&#xf0a3; No Win Stats</option>'
              +'<option class="fa" value="excludeincomplete">&#x25d1; No Incomplete</option>'
            +'</select>'
        ...
        +'<div id="SPLU.StatsMenu" style="display:none;">'
          +'Stat: <select class="fa" id="SPLU.SelectStat" onChange="javascript:{loadStats(\'choose\');}">'
            +'<option class="fa" value="PlaysWins" selected>Wins</option>'
            +'<option class="fa" value="BeginnersLuck">Beginner\'s Luck</option>'
            +'<option class="fa" value="GameDetails">Game Details</option>'
            +'<option class="fa" value="Locations">Locations</option>'
          +'</select>'
    ...
    if(filter!="add" && filter!="---" && filter!="DEL"){
      ...
      if(filter=="objecttype"){
        tmpHTML+='Type: <select class="fa" name="SPLU.PlaysFiltersLine" data-SPLU-FilterType="'+filter+'" onChange="javascript:{loadPlays(document.getElementById(\'SPLU.PlaysLogger\').value,false);}">'
          +'<option class="fa" value="boardgame">&#9818; Board Game</option>'
          +'<option class="fa" value="videogame">&#xf11b; Video Game</option>'
          +'<option class="fa" value="rpgitem">&#9860; RPG Item</option>'
          +'</select>';
      }
