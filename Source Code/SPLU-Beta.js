// SPLU 5.2.3 Beta
  ...
  function addPlaysFilter(){
    ...
    if(filter!="add" && filter!="---"){
      ...
      tmpHTML='<a href="javascript:{void(0);}" onclick="javascript:{document.getElementById(\'SPLU.PlaysFiltersCurrent\').removeChild(document.getElementById(\'SPLU.playsFiltersLine'+SPLUplaysFiltersCount+'\'));loadPlays(document.getElementById(\'SPLU.PlaysLogger\').value);}" style="color:red;margin:2px;">'
    ...
    +'<div style="display:table;">'
      +'<div style="display:table-row;">'
        +'<div class="BRcells">'
          ...
          +'<a href="javascript:{void(0);}" onClick="javascript:{showPlayersPane(\'button\');}" id="showPlayersPaneBtn"><img src="https://cf.geekdo-images.com/images/pic2480337.png"></a>'
  ...
  +'<div style="display:table; margin-top:15px;">'
    +'<div style="display:table-row;">'
      ...
      +'<div class="BRcells" id="SPLUdeletePlayDiv" style="display:none;">'
        +'<div>'
          +'<a href="javascript:{void(0);}" onClick="javascript:{deleteGamePlay();}" style="border:2px solid blue;padding:5px 4px;border-radius:5px;background-color:lightGrey; color:black;" id="DeleteGamePlayBtn";><img src="https://cf.geekdo-images.com/images/pic2476931.png" style="vertical-align: middle; margin-right: 3px;"></a>'
        +'</div>'
      +'</div>'
      +'<div class="BRcells" id="SPLUresetFormDiv">'
        +'<div>'
          +'<a href="javascript:{void(0);}" onClick="javascript:{clearForm();}" style="border:2px solid blue;padding:5px 4px;border-radius:5px;background-color:lightGrey; color:black;" id="ResetFormBtn"><img src="https://cf.geekdo-images.com/images/pic2476932.png" style="vertical-align: middle; margin-right:3px;"></a>'
        +'</div>'
      +'</div>'
      +'<div class="BRcells">'
