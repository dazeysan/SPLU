          ...
          +'<div id="SPLU.LocationField" style="width:275px;">'
            ...
            +'<div style="display:inline-block; position:absolute; padding-top:2px;padding-left:4px;">'
              +'<a href="javascript:{void(0);}" onClick="javascript:{showLocationsPane(\'button\');}" id="showLocationsPaneBtn">'
                +'<span class="fa-stack">'
                  +'<i class="fa fa-bars fa-stack-2x fa-pull-right" style="color: rgb(110, 104, 104);"></i>'
                  +'<i class="fa fa-stack-2x fa-pull-left" style="color: rgb(164, 223, 243); text-shadow: -1px 5px rgb(164, 223, 243);">&#xee09;</i>'
                  +'<i style="color: rgb(211, 60, 199); text-shadow: 2px -1px rgb(164, 223, 243);" class="fa fa-map-marker fa-stack-2x fa-pull-left"></i>'
                +'</span>'
              +'</a>'
            +'</div>'
            +'<br/>'
