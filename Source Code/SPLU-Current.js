javascript:
{
  ...
  function insertPlayer(player){
    ...
    tmpDiv.innerHTML='<input type="text" style="width:50px;" name="players['+NumOfPlayers+'][position]" tabindex="4'+paddedNum+'"></input>';
    document.getElementById('SPLU.PlayerRow'+NumOfPlayers).appendChild(tmpDiv);
    ...
    tmpDiv.innerHTML='<input type="text" style="width:37px;" name="players['+NumOfPlayers+'][score]" tabindex="5'+paddedNum+'"></input>';
    document.getElementById('SPLU.PlayerRow'+NumOfPlayers).appendChild(tmpDiv);
    ...
    tmpDiv.innerHTML='<input type="text" style="width:32px;" name="players['+NumOfPlayers+'][rating]" tabindex="6'+paddedNum+'"></input>';
    document.getElementById('SPLU.PlayerRow'+NumOfPlayers).appendChild(tmpDiv);
    ...
    tmpDiv.innerHTML='<input type="checkbox" name="players['+NumOfPlayers+'][win]" class="SPLU.WinBox" value="1"  tabindex="7'+paddedNum+'" style="margin-bottom:2px;" onClick="javascript:{if(SPLU.Settings.WinComments.Visible){NoreenWinComment();}}"></input>';
    document.getElementById('SPLU.PlayerRow'+NumOfPlayers).appendChild(tmpDiv);
    ...
    tmpDiv.innerHTML='<input type="checkbox" name="players['+NumOfPlayers+'][new]" value="1"  tabindex="8'+paddedNum+'" style="margin-bottom:2px;"></input>';
    document.getElementById('SPLU.PlayerRow'+NumOfPlayers).appendChild(tmpDiv);
  ...
  var tmpHTML='<div style="float:right;margin-left:-20px; margin-right:-15px; margin-top:-13px;">
    <div id="closeButton" style=""><a href="javascript:{void(0);}" onClick="javascript:{hidePopText();observer.disconnect();BRlogMain.parentNode.removeChild(BRlogMain);}" style="border:2px solid blue;padding:0px 10px;border-top-right-radius: 15px; border-bottom-left-radius: 5px;background-color:lightGrey;font-size:large;font-weight:900;color:red;">X</a></div>
    <div style="padding-top: 15px; padding-left: 8px;"><a href="javascript:{void(0);}" onClick="javascript:{showSettingsPane(\'button\');}" id="BRshowHideBtn"><img src="http://cf.geekdo-images.com/images/pic2319219.png"></a></div>
    ...
    <div id="SPLU.DateField" class="BRcells" style="width:120px;">
      <div style="display:table;">
        <div style="display:table-row;">
          ...
          <div style="display:inline;">
            <a href="javascript:{void(0);}" onClick="javascript:{showHideCalendar();}">
              <img style="vertical-align:bottom;" src="//cf.geekdo-static.com/images/icons/silkicons/calendar_view_week.png">
            </a>
          </div>
          <div id="SPLU.Calendar" style="position:absolute;z-index:600;display:none;">C</div>
        </div>
        <div style="display:table-row;">
          <div style="display:table-cell;font-size:x-small;padding-top:7px;">
            <a href="javascript:{void(0);}" onClick="javascript:{setDateField(\''+daybeforeDate+'\')}">'+daybeforeText+'</a> | <a href="javascript:{void(0);}" onClick="javascript:{setDateField(\''+yesterdayDate+'\')}">'+yesterdayText+'</a> | <a href="javascript:{void(0);}" onClick="javascript:{setDateField(\''+todayDate+'\')}">'+todayText+'</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="BRcells" style="padding-right:20px;">
      <div id="SPLU.QuantityField" style="margin-bottom:5px;width:75px;">
        <span style="font-size:xx-small;">Quantity: </span><input type="text" id="quickplay_quantity99" name="quantity" value="1" tabindex="30" style="width: 20px;"/>
      </div>
      <div id="SPLU.DurationField" style="width:75px;">
        <span style="font-size:xx-small;">Duration: </span><input type="text" id="quickplay_duration99" name="length" value="" tabindex="40" style="width: 20px;"/>
      </div>
    </div>
    ...
    <div class="BRcells">
      <div id="SPLU.LocationField" style="width:275px;">
        <div id="SPLU.fakeLocationBox" style="width:200px; display:inline-block; -moz-appearance:textfield; -webkit-appearance:textfield;">
          ...
          <a href="javascript:{void(0);}" onClick="javascript:{saveLocation();}" style="vertical-align:middle;" id="SPLU.SaveLocationButton">
            <img src="http://cf.geekdo-images.com/images/pic2345639.png">
          </a>
        </div>
        <a href="javascript:{void(0);}" onClick="javascript:{showHideLocations();}" id="BRlocsBtn" style="padding-left:1px; vertical-align:middle;">
          <span id="SPLU.LocationButtonIconCollapse" style="display:inline-block;">
            <img src="http://cf.geekdo-images.com/images/pic2321002.png">
          </span>
          <span id="SPLU.LocationButtonIconExpand" style="display:none;">
            <img src="http://cf.geekdo-images.com/images/pic2320964.png">
          </span>
        </a>
        <div style="display:inline-block; position:absolute; padding-top:2px;padding-left:4px;"><a href="javascript:{void(0);}" onClick="javascript:{showLocationsPane(\'button\');}" id="showLocationsPaneBtn"><img src="https://cf.geekdo-images.com/images/pic2344362.png"></a></div>
        <br/>
    ...
    <div style="display:table-row;">
      ...
      <div class="BRcells" style="margin-top:5px;vertical-align:top;">
        <div id="SPLU.GameField">
          ...
          <div id="objectiddisp546e9ffd96dfc" style="display:none;">ID: </div>
        ...
        <div style="display:table;">
          ...
          <div style="display:table-cell; vertical-align:top;">
            ...
            <div style="padding-bottom:5px; padding-top:7px;"><a href="javascript:{void(0);}" onClick="javascript:{addFavorite();}" id="favoritesAddToList" style="padding:4px;"><img src="https://cf.geekdo-images.com/images/pic2321598.png" border="0"></a></div>
            <div><a javascript:{void(0);}" onClick="javascript:{SPLUgameID=document.getElementById(\'objectid0\').value;showExpansionsPane(\'button\');}" id="expansionLoggingButton" style="padding:4px;"><img src="https://cf.geekdo-images.com/images/pic2344399.png" border="0"></a></div>
          </div>
        </div>
    ...
    <a href="javascript:{void(0);}" onClick="javascript:{showPlayersPane(\'button\');}" id="showPlayersPaneBtn"><img src="https://cf.geekdo-images.com/images/pic2346497.png"></a>
    <div style="display:inline;" id="SPLU.PlayerFilters"><select id="SPLU.SelectFilter" onChange="javascript:{setFilter(\'choose\');}"></select></div>
    <div id="SPLU.PlayerList" style="padding-top:15px 0px 3px 0px; width:450px;">Loading...</div>
    </div></div></div>
  

    <div id="SPLUplayerRows" style="display:table; padding-bottom:15px;">
    <div style="display:table-row;">
    <div class="SPLUplayerCells" style="width:25px;">
    
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerNameColumnHeader">
    <div id="SPLU.PlayerNameColumn" class="SPLUheader" style="min-width:38px;"><div id="collapseName" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerNameColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Name</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerUsernameColumnHeader">
    <div id="SPLU.PlayerUsernameColumn" class="SPLUheader" style="min-width:66px;"><div id="collapseUsername" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerUsernameColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Username</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerColorColumnHeader">
    <div id="SPLU.PlayerColorColumn" class="SPLUheader" style="min-width:36px;"><div id="collapseColor" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerColorColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Team<br/>Color</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerPositionColumnHeader">
    <div id="SPLU.PlayerPositionColumn" class="SPLUheader" style="min-width:33px;"><div id="collapseStart" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerPositionColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Start<br/>Pos</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerScoreColumnHeader">
    <div id="SPLU.PlayerScoreColumn" class="SPLUheader" style="min-width:37px;"><div id="collapseScore" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerScoreColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Score</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerRatingColumnHeader">
    <div id="SPLU.PlayerRatingColumn" class="SPLUheader" style="min-width:32px;"><div id="collapseRating" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerRatingColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Rate</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerWinColumnHeader">
    <div id="SPLU.PlayerWinColumn" class="SPLUheader" style="min-width:30px;"><div id="collapseWin" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerWinColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>Win</center></div>
    </div>
    <div class="SPLUplayerCells" id="SPLU.PlayerNewColumnHeader">
    <div id="SPLU.PlayerNewColumn" class="SPLUheader" style="min-width:30px;"><div id="collapseNewPlayer" class="SPLUheaderClose"><a href="javascript:{void(0);}" onClick="javascript:{hideColumn(\'PlayerNewColumn\');}"><img src=http://cf.geekdo-images.com/images/pic2284822.png></a></div><center>New</center></div></div>
    </div></div></div>
  
    <div style="display:table; margin-top:15px;">
    <div style="display:table-row;">
    <div class="BRcells">
    <div><a href="javascript:{void(0);}" onClick="javascript:{saveGamePlay(\'none\');}" style="border:2px solid blue;padding:2px 4px;border-radius:5px;background-color:lightGrey; color:black;" id="SaveGamePlayBtn" onMouseOver="makeSentence();" onMouseOut="hideSentence();">Submit</a></div>
    </div>
    <div class="BRcells">
    <div><a href="javascript:{void(0);}" onClick="javascript:{saveGamePlay(\'dupe\');}" style="border:2px solid blue;padding:2px 4px;border-radius:5px;background-color:lightGrey; color:black;" id="SaveGamePlayBtnDupe" onMouseOver="makeSentence();" onMouseOut="hideSentence();">Submit & Duplicate</a></div>
    </div>
    <div class="BRcells">
  ...
  var tmpHTML='<div id="hideSettingsButton" style="position: absolute; right: 0px; top: 2px;"><a href="javascript:{void(0);}" onClick="javascript:{hidePopText();document.getElementById(\'BRlog\').style.minWidth=\'\';document.getElementById(\'BRlogSettings\').style.display=\'none\';}" style="border:2px solid black;padding:0px 8px;border-top-right-radius: 15px; border-bottom-left-radius: 5px;background-color:lightGrey;font-size:x-large;font-weight:900;color:red;"><img src="http://cf.geekdo-images.com/images/pic2336662.png"></a></div>
    <span style="font-variant:small-caps; font-weight:bold; font-size:13px;"><center>Settings</center></span>
    <div style="display:table;">
    <div style="display:table-row;">
    ...
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.DateFieldCheck" onClick="javascript:{showHide(\'DateField\');}" ></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.DateFieldReset" onclick="javascript:{SPLU.Settings.DateField.Reset=document.getElementById(\'SPLU.DateFieldReset\').checked;}"></input></div>
    </div>
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Location</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.LocationFieldCheck" onClick="javascript:{showHide(\'LocationField\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.LocationFieldReset" onclick="javascript:{SPLU.Settings.LocationField.Reset=document.getElementById(\'SPLU.LocationFieldReset\').checked;}"></input></div>
    </div>
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Saved Location List</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.LocationListCheck" onClick="javascript:{showHideLocations(\'true\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.LocationListReset" onclick="javascript:{SPLU.Settings.LocationList.Reset=document.getElementById(\'SPLU.LocationListReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Quantity</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.QuantityFieldCheck" onclick="javascript:{showHide(\'QuantityField\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.QuantityFieldReset" onclick="javascript:{SPLU.Settings.QuantityField.Reset=document.getElementById(\'SPLU.QuantityFieldReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Duration</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.DurationFieldCheck" onclick="javascript:{showHide(\'DurationField\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.DurationFieldReset" onclick="javascript:{SPLU.Settings.DurationField.Reset=document.getElementById(\'SPLU.DurationFieldReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Comments</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.CommentsFieldCheck" onclick="javascript:{showHide(\'CommentsField\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.CommentsFieldReset" onclick="javascript:{SPLU.Settings.CommentsField.Reset=document.getElementById(\'SPLU.CommentsFieldReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Game</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.GameFieldCheck" onclick="javascript:{showHide(\'GameField\');}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>

    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Domain Buttons</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.DomainButtonsCheck" onclick="javascript:{showHide(\'DomainButtons\');}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>
    ...
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerListCheck" onclick="javascript:{showHide(\'PlayerList\');}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>
    
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Enable Filters</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerFiltersCheck" onclick="javascript:{showHideFilters();}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>
    
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Enable Groups</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerGroupsCheck" onclick="javascript:{showHideGroups();}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>

    <div style="display:table-row;"><div style="display:table-cell; text-align:left; padding-top:10px;"><b>Player Columns</b></div></div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Name</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerNameColumnCheck" onclick="javascript:{hideColumn(\'PlayerNameColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerNameColumnReset" onclick="javascript:{SPLU.Settings.PlayerNameColumn.Reset=document.getElementById(\'SPLU.PlayerNameColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Username</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerUsernameColumnCheck" onclick="javascript:{hideColumn(\'PlayerUsernameColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerUsernameColumnReset" onclick="javascript:{SPLU.Settings.PlayerUsernameColumn.Reset=document.getElementById(\'SPLU.PlayerUsernameColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Team / Color</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerColorColumnCheck" onclick="javascript:{hideColumn(\'PlayerColorColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerColorColumnReset" onclick="javascript:{SPLU.Settings.PlayerColorColumn.Reset=document.getElementById(\'SPLU.PlayerColorColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Starting Position</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerPositionColumnCheck" onclick="javascript:{hideColumn(\'PlayerPositionColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerPositionColumnReset" onclick="javascript:{SPLU.Settings.PlayerPositionColumn.Reset=document.getElementById(\'SPLU.PlayerPositionColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Score</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerScoreColumnCheck" onclick="javascript:{hideColumn(\'PlayerScoreColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerScoreColumnReset" onclick="javascript:{SPLU.Settings.PlayerScoreColumn.Reset=document.getElementById(\'SPLU.PlayerScoreColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Rating</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerRatingColumnCheck" onclick="javascript:{hideColumn(\'PlayerRatingColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerRatingColumnReset" onclick="javascript:{SPLU.Settings.PlayerRatingColumn.Reset=document.getElementById(\'SPLU.PlayerRatingColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Win</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerWinColumnCheck" onclick="javascript:{hideColumn(\'PlayerWinColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerWinColumnReset" onclick="javascript:{SPLU.Settings.PlayerWinColumn.Reset=document.getElementById(\'SPLU.PlayerWinColumnReset\').checked;}"></input></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">New</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerNewColumnCheck" onclick="javascript:{hideColumn(\'PlayerNewColumn\');}"></input></div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PlayerNewColumnReset" onclick="javascript:{SPLU.Settings.PlayerNewColumn.Reset=document.getElementById(\'SPLU.PlayerNewColumnReset\').checked;}"></input></div>
    </div>
    <div style="display:table-row;"><div style="display:table-cell; text-align:left; padding-top:10px;"><b>Other Stuff</b></div></div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Pop-Up Text</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.PopUpTextCheck" onclick="javascript:{SPLU.Settings.PopUpText.Visible=document.getElementById(\'SPLU.PopUpTextCheck\').checked;}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>
  
    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Summary Sentence</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.SummaryTextFieldCheck" onclick="javascript:{showHide(\'SummaryTextField\');}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>
  
    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Noreen\'s Win Comments</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.WinCommentsCheck" onclick="javascript:{SPLU.Settings.WinComments.Visible=document.getElementById(\'SPLU.WinCommentsCheck\').checked; if(SPLU.Settings.WinComments.Visible){NoreenWinComment();}}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>

    <div style="display:table-row;">
    <div style="display:table-cell; text-align:right;">Sort Players: Alpha</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.SortPlayersAlphaCheck" onclick="javascript:{if(document.getElementById(\'SPLU.SortPlayersAlphaCheck\').checked){SPLU.Settings.SortPlayers.Order=\'Alpha\';}else{SPLU.Settings.SortPlayers.Order=\'None\';} loadPlayers();}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>

    <div style="display:table-row;" class="SPLUsettingAltRows">
    <div style="display:table-cell; text-align:right;">Sort Groups: Alpha</div>
    <div style="display:table-cell; text-align:center;"><input type="checkbox" id="SPLU.SortGroupsAlphaCheck" onclick="javascript:{if(document.getElementById(\'SPLU.SortGroupsAlphaCheck\').checked){SPLU.Settings.SortGroups.Order=\'Alpha\';}else{SPLU.Settings.SortGroups.Order=\'None\';} loadPlayers();}"></input></div>
    <div style="display:table-cell; text-align:center;"></div>
    </div>
    ...
    <div style="display:table-row;">
    <div style="display:table-cell; padding-right:10px;"><a href="javascript:{void(0);}" onClick="javascript:{saveSettings(\'Saved\');}" class="BRbutn" style="border:2px solid black;padding:2px 4px;border-radius:5px;background-color:lightGrey; color:black;">Save Settings</a></div>
    <div style="display:table-cell;width:135px;" id="SPLU.SettingsStatus"></div>
    <div style="display:table-cell;" id="SPLU.SettingsReset"><a href="javascript:{void(0);}" onClick="javascript:{resetSettings();saveSettings(\'Settings Reset. Please close SPLU.\');}" style="color:red;">!</a></div>
    </div></div>
